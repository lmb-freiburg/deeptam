...
def main():
    ...
    parser.add_argument('--data_dir', help='set a sequence data directory (should be consistent with TUM RGBD-SLAM datasets), by default use sequence ../data/eth_depth_sample', default=None)
    ...
    if data_dir is None:
        data_dir = os.path.join(examples_dir, '..', 'data', 'eth_depth_sample')
